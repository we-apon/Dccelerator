...
namespace Dccelerator.UnEnumeratedHelpers
{
    ...
    public static class EnumerableUtils
    {
        ...
        public static  IOrderedEnumerable<T> Shuffle<T>( this IEnumerable<T> collection) {
            return collection.OrderBy(x => _random.Value.Next());
        }
        ...
        public static bool HasAny(this IEnumerable enumerable) {
            ...
            try {
                ...
                Log.TraceEvent(TraceEventType.Warning, e.ToString());
                return false;
            }
        }
        ...
        /// <summary>
        /// Returns <see langword="true"/> if <paramref name="text"/> is null, empty or white space.
        /// </summary>
