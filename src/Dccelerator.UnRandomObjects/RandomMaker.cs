...
namespace Dccelerator.UnRandomObjects
{
    ...
    public class RandomMaker
    {
        ...
        public static T Make<T>(bool? includeGuids, params Action<T>[] actions) where T : new() {
            ...
            foreach (var doActionOn in actions) {
                doActionOn(entity);
            }
        ...
        public static string MakeString(int? length = null, short? minCharIdx = 1040, short? maxCharIdx = 1071, bool includeDigits = false) {
            ...
            while (idx++ < length) {
                ...
                if (includeDigits && IsOdd(StaticRandom.Next()))
                ...
                builder.Append(IsOdd(StaticRandom.Next()) ? next : char.ToLower(next));
            }
        ...
        static bool TrySetRandomValue(object entity, PropertyInfo prop, bool includeGuids) {
            ...
            return value != null && entity.TrySet(prop.Name, value); //todo: need convertion
        }
