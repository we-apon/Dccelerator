...
{
    /// <summary>
    /// Tells to <see cref="SmartConvert"/> utility that marked type can be converted from other types through some kind of <see cref="IConvertHelper"/>
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
    public class ConvertibleFromAttribute : Attribute, IConvertibleAttribute
    {
        private static readonly Type _convertHelperType = typeof (IConvertHelper);
        private Type _through;

        /// <summary>
        /// Types, from that marked member can be converted
        /// </summary>
        ...
        /// Constructor
        /// </summary>
        /// <param name="targetTypes">Types, from that marked with current attribute class can be converted</param>
        public ConvertibleFromAttribute( params Type[] targetTypes) {
